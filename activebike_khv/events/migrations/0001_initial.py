# Generated by Django 3.2.9 on 2022-11-14 03:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=events.models.get_image_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('images', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='events.image')),
            ],
        ),
        migrations.CreateModel(
            name='Ip',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_pub', models.DateTimeField(auto_now_add=True)),
                ('date_edit', models.DateTimeField(auto_now=True)),
                ('album', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='image_album', to='events.imagealbum')),
                ('tags', models.ManyToManyField(blank=True, to='events.Tag', verbose_name='Теги')),
                ('views', models.ManyToManyField(blank=True, editable=False, to='events.Ip')),
            ],
        ),
        migrations.CreateModel(
            name='Route',
            fields=[
                ...
                ('url', models.CharField(blank=True, max_length=200, null=True, verbose_name='ссылка на трек (необязательно)')),
